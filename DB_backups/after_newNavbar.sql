...
-- Started on 2026-03-18 13:39:28
...
--
-- TOC entry 252 (class 1255 OID 24742)
...
--
-- TOC entry 294 (class 1255 OID 24794)
...
--
-- TOC entry 292 (class 1255 OID 16628)
...
--
-- TOC entry 266 (class 1255 OID 24748)
...
--
-- TOC entry 268 (class 1255 OID 24632)
...
--
-- TOC entry 299 (class 1255 OID 24670)
...
--
-- TOC entry 297 (class 1255 OID 24814)
...
--
-- TOC entry 270 (class 1255 OID 24697)
...
DECLARE
    ...
    operation_type TEXT;
BEGIN
    SELECT role INTO reviewer_role FROM users WHERE user_id = p_reviewer_id;
...
--
-- TOC entry 271 (class 1255 OID 24703)
...
--
-- TOC entry 296 (class 1255 OID 24797)
...
--
-- TOC entry 264 (class 1255 OID 16630)
...
--
-- TOC entry 293 (class 1255 OID 24743)
...
--
-- TOC entry 306 (class 1255 OID 24823)
...
--
-- TOC entry 305 (class 1255 OID 24822)
...
--
-- TOC entry 301 (class 1255 OID 24820)
...
--
-- TOC entry 303 (class 1255 OID 24821)
...
--
-- TOC entry 302 (class 1255 OID 24818)
...
--
-- TOC entry 304 (class 1255 OID 24819)
...
--
-- TOC entry 298 (class 1255 OID 24816)
...
--
-- TOC entry 265 (class 1255 OID 24649)
...
--
-- TOC entry 295 (class 1255 OID 24796)
...
--
-- TOC entry 291 (class 1255 OID 24704)
...
--
-- TOC entry 300 (class 1255 OID 24817)
...
DECLARE
    ...
    new_role_id INTEGER;
BEGIN
    SELECT u.role INTO admin_role FROM users u WHERE u.user_id = p_admin_id;
    IF admin_role != 'admin' THEN
        RAISE EXCEPTION 'Только администратор может редактировать пользователей';
    END IF;
...
--
-- TOC entry 4813 (class 2604 OID 24767)
...
--
-- TOC entry 4809 (class 2604 OID 24755)
...
--
-- TOC entry 4805 (class 2604 OID 24656)
...
--
-- TOC entry 4807 (class 2604 OID 24679)
...
--
-- TOC entry 4802 (class 2604 OID 16571)
...
--
-- TOC entry 4804 (class 2604 OID 16585)
...
--
-- TOC entry 4815 (class 2604 OID 24802)
...
--
-- TOC entry 4799 (class 2604 OID 16558)
...
--
-- TOC entry 5020 (class 0 OID 24764)
-- Dependencies: 232
...
--
-- TOC entry 5021 (class 0 OID 24779)
-- Dependencies: 233
...
--
-- TOC entry 5018 (class 0 OID 24752)
-- Dependencies: 230
...
INSERT INTO public.assignments VALUES (5, 'Лабораторная работа №2', 'В этой лабораторной работе вам предстоит...', '1) Возьмите...', true, '2026-03-18 12:30:40.033789', '2026-03-18 12:32:18.806861');


--
-- TOC entry 5014 (class 0 OID 24653)
-- Dependencies: 226
...
INSERT INTO public.audit_log VALUES (127, 'UPDATE', 'experiments', 67, NULL, '2026-03-03 00:27:32.839643+03', NULL);
...
INSERT INTO public.audit_log VALUES (134, 'UPDATE', 'experiments', 58, NULL, '2026-03-09 14:42:13.642091+03', NULL);
...
INSERT INTO public.experiment_reagents VALUES (40, 1, 1, 'г');
...
INSERT INTO public.experiment_reagents VALUES (69, 11, 1, 'мл');


--
-- TOC entry 5016 (class 0 OID 24676)
-- Dependencies: 228
...
INSERT INTO public.experiment_reviews VALUES (10, 40, 2, 4, 'ocenca', '2025-12-19 11:42:27.59593+03');
INSERT INTO public.experiment_reviews VALUES (14, 57, 2, 3, NULL, '2026-03-03 11:32:32.612438+03');


--
-- TOC entry 5009 (class 0 OID 16568)
-- Dependencies: 221
-- Data for Name: experiments; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.experiments VALUES (69, '2026-03-03', 'test', 'test', 2, 'TEST');
...
INSERT INTO public.experiments VALUES (68, '2026-02-28', 'test sensitive', 'test sensitive', 1, NULL);
...
INSERT INTO public.experiments VALUES (40, '2025-12-10', '— Скажи-ка, дядя, ведь не даром
...
Не отдали б Москвы!', '— Скажи-ка, дядя, ведь не даром
Москва, спаленная пожаром,
Французу отдана?
Ведь были ж схватки боевые,
Да, говорят, еще какие!
...
--
-- TOC entry 5011 (class 0 OID 16582)
-- Dependencies: 223
...
--
-- TOC entry 5023 (class 0 OID 24799)
-- Dependencies: 235
...
--
-- TOC entry 5007 (class 0 OID 16555)
-- Dependencies: 219
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.users VALUES (2, 'admin', '$2a$12$TX.cI04Al3qv/vPcXaz0cuMF0z9iHd83UWqGvPkGy8JtbwXVlMwHW', '2025-12-10 22:08:53.487638', true, 'Admin', '', '', 3);
INSERT INTO public.users VALUES (3, 'teacher', '$2a$12$K0WZ8ZV.nvJcIzBKyRVEQeMjMHn9YKdYu6YyXXmsDM/KMZX2OuaN.', '2025-12-10 22:12:36.168722', true, 'teacher1', '', '', 2);
...
INSERT INTO public.users VALUES (22, 'test1', '$2b$10$YpV902dBYkXZiIKuWBhFhOmzqf/9FmmgR7vwxwcxORm4fUsQ7zvhK', '2026-03-15 11:50:47.48715', true, 'test ', 'test', 'Test1', 1);
...
SELECT pg_catalog.setval('public.audit_log_log_id_seq', 134, true);
...
SELECT pg_catalog.setval('public.experiment_reviews_review_id_seq', 14, true);
...
--
-- TOC entry 4842 (class 2606 OID 24773)
...
--
-- TOC entry 4844 (class 2606 OID 24783)
...
--
-- TOC entry 4840 (class 2606 OID 24762)
...
--
-- TOC entry 4835 (class 2606 OID 24662)
...
--
-- TOC entry 4833 (class 2606 OID 16599)
...
--
-- TOC entry 4837 (class 2606 OID 24685)
...
--
-- TOC entry 4827 (class 2606 OID 16575)
...
--
-- TOC entry 4829 (class 2606 OID 16591)
...
--
-- TOC entry 4846 (class 2606 OID 24806)
...
--
-- TOC entry 4848 (class 2606 OID 24808)
...
--
-- TOC entry 4823 (class 2606 OID 16564)
...
--
-- TOC entry 4825 (class 2606 OID 16566)
...
--
-- TOC entry 4838 (class 1259 OID 24701)
...
--
-- TOC entry 4860 (class 2620 OID 24669)
...
--
-- TOC entry 4859 (class 2620 OID 24668)
...
--
-- TOC entry 4856 (class 2606 OID 24774)
...
--
-- TOC entry 4857 (class 2606 OID 24784)
...
--
-- TOC entry 4858 (class 2606 OID 24789)
...
--
-- TOC entry 4853 (class 2606 OID 24663)
...
--
-- TOC entry 4851 (class 2606 OID 16600)
...
--
-- TOC entry 4852 (class 2606 OID 16605)
...
--
-- TOC entry 4854 (class 2606 OID 24686)
...
--
-- TOC entry 4855 (class 2606 OID 24691)
...
--
-- TOC entry 4850 (class 2606 OID 16576)
...
--
-- TOC entry 4849 (class 2606 OID 24809)
...
-- Completed on 2026-03-18 13:39:28
