...
-- Started on 2026-05-02 17:45:30
...
--
-- TOC entry 310 (class 1255 OID 24827)
-- Name: get_experiments(integer, date, date, integer, boolean, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_experiments(p_filter_user_id integer DEFAULT NULL::integer, p_filter_date_from date DEFAULT NULL::date, p_filter_date_to date DEFAULT NULL::date, p_filter_reagent_id integer DEFAULT NULL::integer, p_unrated_only boolean DEFAULT false, p_user_search text DEFAULT NULL::text) RETURNS TABLE(experiment_id integer, theme text, date_conducted date, description text, observations text, last_name text, first_name text, middle_name text, user_id integer, reagents json, has_review boolean)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    SELECT
        ...
        (erw.experiment_id IS NOT NULL) AS has_review
    FROM experiments e
    JOIN users u ON u.user_id = e.user_id
    LEFT JOIN experiment_reagents er ON er.experiment_id = e.experiment_id
    LEFT JOIN reagents r ON r.reagent_id = er.reagent_id
    LEFT JOIN experiment_reviews erw ON erw.experiment_id = e.experiment_id
    WHERE 
        (p_filter_user_id IS NULL OR e.user_id = p_filter_user_id)
        AND (
            p_user_search IS NULL 
            OR u.last_name ILIKE '%' || p_user_search || '%'
            OR u.first_name ILIKE '%' || p_user_search || '%'
            OR u.middle_name ILIKE '%' || p_user_search || '%'
            OR e.user_id::TEXT = p_user_search
        )
        ...
        AND (p_filter_reagent_id IS NULL OR e.experiment_id IN (
            SELECT er2.experiment_id 
            FROM experiment_reagents er2 
            WHERE er2.reagent_id = p_filter_reagent_id
        ))

        AND (NOT p_unrated_only OR erw.experiment_id IS NULL)
    GROUP BY 
        e.experiment_id, 
        u.last_name, 
        u.first_name, 
...
ALTER FUNCTION public.get_experiments(p_filter_user_id integer, p_filter_date_from date, p_filter_date_to date, p_filter_reagent_id integer, p_unrated_only boolean, p_user_search text) OWNER TO postgres;
...
--
-- TOC entry 4817 (class 2604 OID 24767)
...
--
-- TOC entry 4813 (class 2604 OID 24755)
...
--
-- TOC entry 4809 (class 2604 OID 24656)
...
--
-- TOC entry 4811 (class 2604 OID 24679)
...
--
-- TOC entry 4806 (class 2604 OID 16571)
...
--
-- TOC entry 4808 (class 2604 OID 16585)
...
--
-- TOC entry 4819 (class 2604 OID 24802)
...
--
-- TOC entry 5024 (class 0 OID 24764)
-- Dependencies: 232
...
--
-- TOC entry 5025 (class 0 OID 24779)
-- Dependencies: 233
...
--
-- TOC entry 5022 (class 0 OID 24752)
-- Dependencies: 230
...
--
-- TOC entry 5018 (class 0 OID 24653)
-- Dependencies: 226
...
--
-- TOC entry 5020 (class 0 OID 24676)
-- Dependencies: 228
...
--
-- TOC entry 5013 (class 0 OID 16568)
-- Dependencies: 221
...
--
-- TOC entry 5015 (class 0 OID 16582)
-- Dependencies: 223
...
--
-- TOC entry 5027 (class 0 OID 24799)
-- Dependencies: 235
...
--
-- TOC entry 4846 (class 2606 OID 24773)
...
--
-- TOC entry 4848 (class 2606 OID 24783)
...
--
-- TOC entry 4844 (class 2606 OID 24762)
...
--
-- TOC entry 4839 (class 2606 OID 24662)
...
--
-- TOC entry 4837 (class 2606 OID 16599)
...
--
-- TOC entry 4841 (class 2606 OID 24685)
...
--
-- TOC entry 4831 (class 2606 OID 16575)
...
--
-- TOC entry 4833 (class 2606 OID 16591)
...
--
-- TOC entry 4850 (class 2606 OID 24806)
...
--
-- TOC entry 4852 (class 2606 OID 24808)
...
--
-- TOC entry 4829 (class 2606 OID 16566)
...
--
-- TOC entry 4842 (class 1259 OID 24701)
...
--
-- TOC entry 4864 (class 2620 OID 24669)
...
--
-- TOC entry 4863 (class 2620 OID 24668)
...
--
-- TOC entry 4860 (class 2606 OID 24774)
...
--
-- TOC entry 4862 (class 2606 OID 24789)
...
--
-- TOC entry 4857 (class 2606 OID 24663)
...
--
-- TOC entry 4856 (class 2606 OID 16605)
...
--
-- TOC entry 4858 (class 2606 OID 24686)
...
--
-- TOC entry 4859 (class 2606 OID 24691)
...
--
-- TOC entry 4853 (class 2606 OID 24809)
...
-- Completed on 2026-05-02 17:45:30
